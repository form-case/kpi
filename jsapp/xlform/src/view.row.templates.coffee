module.exports = do ->
  ...
  rowErrorView = (atts)->
    ...
    <div class="card card--error">
      ...
      <em>#{replaceSupportEmail(t("This question could not be imported. Please re-create it manually. Please contact us at help@form-case.org so we can fix this bug!"))}</em>
    </div>
    #{expandingSpacerHtml}
    """
